...
<%
    ...
    String dept_add_url=basePath+"pages/back/admin/dept/dept_add_do.jsp";
%>
<html>
<head>
<base href="<%=basePath%>" />
...
<body>
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				<form action="pages/back/admin/dept/dept_add_do.jsp" method="post" class="form-horizontal" id="deptForm">
					<fieldset>
						<legend>
							<label>增加新部门</label>
						</legend>
